/// @file      Achievements.pwn
/// @author    BOURAOUI Al-Moez L.A
/// @date      Created at 2021-07-08 12:44:46 +0100
...
{
    new ach[128];
    GetDBStringField(row, "achivements", ach);
...
SetAchievement(playerid, AchievementID:achievementid)
{
    ...
    DBQuery("UPDATE users SET achivements = '%e' WHERE uid = %i", PlayerAchivements[playerid], PlayerData[playerid][pID]);
