...
CMD:joinfallout(playerid, params[])
{
    ...
    if(!IsPlayerInRangeOfPoint(playerid, 5.0, 945.911132,-1892.398071,10.184990))
	{
	    return SendClientMessage(playerid, COLOR_GREY, "You are not in range of the fallout place.");
	}
