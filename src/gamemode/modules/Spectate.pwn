...
hook OnGameModeInit()
{
    CreateDynamic3DTextLabel("Body Camera\n/watchbodycams to start watch.", COLOR_YELLOW, 745.694152, -1334.215820, -48.669143, 10.0);
...
CMD:WatchBodyCams(playerid, params[])
{
	...
	if (!IsPlayerInRangeOfPoint(playerid, 3.0, 745.694152, -1334.215820, -48.669143))
    {
...
CMD:bodycam(playerid, params[])
{
    ...
    if (!strcmp(option, "on", true))
    {
        ...
        PlayerData[playerid][pBodyCam] = 1;
