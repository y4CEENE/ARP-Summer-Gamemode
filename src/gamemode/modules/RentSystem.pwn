...
hook OnGameModeInit()
{
    Create3DTextLabel("{FFA500}All Saints\nRent a bike", -1, 1218.0000, -1301.0000, 13.1500, 10.0, 0, 0);
    ...
    Create3DTextLabel("{FFA500}Pershing Square\nRent a bike", -1, 1507.0000, -1714.0000, 13.6300, 10.0, 0, 0);// LSPD
    ...
    Create3DTextLabel("{FFA500}Market\nRent a bike", -1, 1115.0000, -1451.0000, 15.3400, 10.0, 0, 0);
    ...
    Create3DTextLabel("{FFA500}Market\nRent a bike", -1, 1142.0000, -1451.0000, 15.3400, 10.0, 0, 0);   
    ...
    Create3DTextLabel("{FFA500}LS Beach Hotel\nRent a bike", -1, 848.9000, -2052.5000, 12.4670, 10.0, 0, 0);   
    ...
    Create3DTextLabel("{FFA500}LS Beach Hotel\nRent a bike", -1, 824.4000, -2052.5000, 12.4670, 10.0, 0, 0);   
    ...
    Create3DTextLabel("{FFA500}County Hospital\nRent a bike", -1, 1979.0000, -1445.0000, 13.1558, 10.0, 0, 0);   
    ...
    Create3DTextLabel("{FFA500}County Hospital\nRent a bike", -1, 1971.6000, -1452.7000, 13.1500, 10.0, 0, 0);   
    ...
    Create3DTextLabel("{FFA500}Casino\nRent a bike", -1, 1453.0000, -1046.1400, 23.4000, 10.0, 0, 0);   
    ...
    Create3DTextLabel("{FFA500}Saint Fierro\nRent a bike", -1, -1509.0000, 736.0000, 6.9500, 10.0, 0, 0);
    rentcar[57] = AddStaticVehicleEx(522, -1509.0000, 728.0000, 6.9500, 90.000 , 1, 1, RENT_VEHICLE_RESPAWN);
    ...
    rentcar[61] = AddStaticVehicleEx(522, -1509.0000, 744.0000, 6.9500, 90.000 , 1, 1, RENT_VEHICLE_RESPAWN);
