...
/// @date      Created at 2022-01-15 13:34:57 +0100
...
stock GiftBox(playerid)
{
    ...
    if (randgift >= 1 && randgift <= 90)
    {
        ...
        switch (gift)
        {
            ...
            case 5:
            {
                ...
                SendClientMessageEx(playerid, COLOR_GREY, "Congratulations, you have won 25 grams of cocaine!");
    ...
    else if (randgift > 90 && randgift <= 99)
    {
        ...
        else if (gift == 3)
        {
            ...
            DBQuery("UPDATE "#TABLE_USERS" SET upgradepoints = %i WHERE uid = %i", PlayerData[playerid][pUpgradePoints], PlayerData[playerid][pID]);
    ...
    else if (randgift > 99 && randgift <= 100)
    {
        ...
        /*if (gift == 1 && PlayerData[playerid][pVIPPackage] <= 2)
        {
            ...
            DBQuery("INSERT INTO flags VALUES(null, %i, 'Giftbox', NOW(), 'Diamond VIP')", PlayerData[playerid][pID]);
        ...
        if (gift == 1)
        {
            ...
            SendClientMessageEx(playerid, COLOR_GREY, " Note: This rare reward may take up to 48 hours to be rewarded.");
            DBQuery("INSERT INTO flags VALUES(null, %i, 'Giftbox', NOW(), 'Free House')", PlayerData[playerid][pID]);
...
hook OnNewHour(timestamp, hour)
{
    ...
    {
        if (PlayerData[i][pLogged] && (IsAdmin(i) || PlayerData[i][pHelper]) && PlayerData[i][pLevel] > 3)
        {
            GiftBox(i);
        }
    }
