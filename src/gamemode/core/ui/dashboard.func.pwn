...
hook OnPlayerInit(playerid)
{
    ...
    DashboardUI[playerid][3] = CreatePlayerTextDraw(playerid, 575.000488, 96.914939, "Server Admins~n~22 Years~n~Male~n~Single");
