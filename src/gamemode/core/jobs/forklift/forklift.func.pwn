...
OnEnterForkliftCheckPoint(playerid)
{
    ...
    if(IsPlayerInRangeOfPoint(playerid, 5, 2642.4553,-2138.4583,13.5469))
    {
        ...
        SetPlayerCheckpoint(playerid, 2449.0776,-2090.1296,13.5469, 5);
    ...
    if(IsPlayerInRangeOfPoint(playerid, 5, 2449.0776,-2090.1296,13.5469))
    {
        ...
        new money = Random(GetJobLevel(playerid, JOB_FORKLIFT) * 200, 100 + GetJobLevel(playerid, JOB_FORKLIFT) * 200);
